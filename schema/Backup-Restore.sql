...
BACKUP DATABASE springboot_asset_dev TO DISK = 'E:\MyBackup\DEVICE_assetManagement.bak' -- Cách 1

BACKUP DATABASE springboot_asset_dev TO DEVICE_assetManagement --Cách 2
...
WHERE BK.database_name = 'springboot_asset_dev'


SELECT * FROM msdb.dbo.backupset WHERE database_name = 'springboot_asset_dev'
